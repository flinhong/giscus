    ...
    return (
      <Html dir={getDir(this.props.locale as AvailableLanguage)}>
        <Head>
          ...
          <link
            rel="stylesheet"
            href="https://cdn.honglin.eu.org/fonts/css?family=IBM+Plex+Mono:ital@0;1&family=Lato:ital@0;1&family=Noto+Serif+SC&family=Zilla+Slab:ital@0;1&display=swap"
